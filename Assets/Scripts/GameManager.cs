...
public class GameManager : MonoBehaviour
{
    ...
    //Se usa para hacer llamadas al mismo código desde códigos distintos
    ...
    private void Awake()
    {
        ...
        if (sharedInstance == null)
            //Rellenala con todo el código que está dentro de este Script
            sharedInstance = this;
    }
    ...
    {
        //Hacemos una referencia a la pelota del juego, para ello la buscamos por etiqueta
        ...
        //Aquí guardamos la velocidad en X que llevaba l apelota en invertimos su signo
